    ...
    <div className="products-and-warranties content-page">
      ...
      <Block>
        ...
        <div className="container u-layout--indent">
          ...
          <div className="row" >
          <Col9 style={{ margin: "0 auto", padding: "20px" }} >
            <div
              className="video"
              style={{
                marginTop: "50px",
          ...
          <div className="row" >
              ...
              <Col11>
                  <p>
                  Please check out our dedicated <a href="/solar-together-faq" style={{color:"#70b33b", fontWeight:"bold"}} > Solar Together FAQs page </a>. Don't see an answer to your question? Feel free to contact us on <a href="tel:02038669896" style={{color:"#70b33b", fontWeight:"bold"}}>020 3866 9896</a> or email us at <a href="mailto:devon@get-uk.com" style={{color:"#70b33b", fontWeight:"bold"}}>devon@get-uk.com</a>.
                  </p>
                  <p>
                  To check out Solar Together's website <a href="https://www.solartogether.co.uk/info/5-most-frequently-asked-questions" style={{color:"#70b33b", fontWeight:"bold"}} target="_blank">click here</a>, or find out more about the registration process in <a href="https://www.youtube.com/watch?v=0qP93bnbm08" style={{color:"#70b33b", fontWeight:"bold"}} target="_blank">this video.</a>
                  </p>
              </Col11>
          </div>
        </div>
