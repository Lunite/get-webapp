...
const CommercialYourQuotePage: React.FC<PageProps> = props => {
  ...
  const getUsageRow = (arr: Array<number>) => {
    ...
    return arr.map((n: number) => {
      ...
      return (
        <td style={{ backgroundColor: color }} key={color}>
          {rnd(n)}
        </td>
      )
    })
              ...
              <table className="hide-mob">
                <tbody>
                  ...
                  <tr>
                    ...
                    {getUsageRow(results.firstYearUse.demandTotal)}
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <td>2</td>
                    <td>
                      Supply, Installation, Commissioning and Handover of
                      Battery Storage System ( {results.batterySize} kWdc )
                    </td>
                  </tr>
                  <tr className="tr-lg">
                    <th>Item</th>
...
export default CommercialYourQuotePage
