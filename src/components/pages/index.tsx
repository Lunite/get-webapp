...
const Homepage = ({ context }) => {
  return (
    <div className="homepage">
      ...
      <Block highlightColour="blue">
        <div className="container">
          <Col8>
            <Heading level={3}>The best solution for your Home</Heading>
            <p>
              We provide a residential solar solution that offers market-leading
              efficiencies in those areas important to homeowners and tenants -
              cost, energy and customer service.
            </p>
            <p>
              We believe that your solar system should be designed based on your
              goals and consumption, not how many solar panels you can fit on
              the property. This ensures our designs are truly cost effective,
              bringing the best returns on your investment.
            </p>
