...
const TO_EMAIL = process.env.TO_EMAIL || "domestic.quotes@get-uk.com"
const FROM_EMAIL = process.env.FROM_EMAIL || "feedback.quotes@get-uk.com"
...
module.exports.handler = async (req, res) => {
  ...
  if (req.method === "OPTIONS") {
    ...
    const msg = {
      ...
      from: { email: FROM_EMAIL, name: "Feedback" },
