...
module.exports.getEmailHTML = (result) => `
<!doctype html>
<html>
<head></head>
<body>
...
<table className="hide-mob">
  ...
  <tr>
    ...
    ${results.firstYearUse.demand.map((n) => ${
      return <td>${rnd(n)}</td>
    })}
  ...
  <tr>
    ...
    ${results.firstYearUse.solar.map((n) => ${
      return <td>${rnd(n)}</td>
    })}
  ...
  <tr>
    ...
    ${results.firstYearUse.exportAfterBattery.map((n) => ${
      return <td>${rnd(n)}</td>
    })}
  ...
  <tr>
    ...
    ${results.firstYearUse.demandTotal.map((n) => ${
      return <td>${rnd(n)}</td>
    })}
